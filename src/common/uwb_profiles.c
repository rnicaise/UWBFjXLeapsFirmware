...
static const uwb_runtime_profile_t profiles[] = {
    {
        .opt = UWB_PROFILE_OPT_6M8_STABLE_CH5,
        .data_rate_kbps = 6800,
        .config = {
            5,
            DWT_PLEN_128,
    ...
    {
        .opt = UWB_PROFILE_OPT_6M8_STABLE_CH9,
        .data_rate_kbps = 6800,
        .config = {
            9,
            DWT_PLEN_128,
    ...
    },
    {
        ...
        .responder_ss_poll_rx_to_resp_tx_dly_uus = 1200,
...
{
    return uwb_profile_opt_for_channel_rate_kbps(5u, rate_kbps);
}
...
uint8_t uwb_profile_opt_for_channel_rate_kbps(uint8_t channel, int rate_kbps)
{
    ...
    if (channel == 9u)
    {
        return UWB_PROFILE_OPT_6M8_STABLE_CH9;
    }
    return UWB_PROFILE_OPT_6M8_STABLE_CH5;
}
